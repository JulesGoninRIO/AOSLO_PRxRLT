AutoAOMontaging MATLAB Python Package
...
2. Installing the AutoAOMontaging Package

A. Change to the directory that contains the file setup.py and the subdirectory 
AutoAOMontaging. If you do not have write permissions, copy all its contents to a 
...
3. Using the AutoAOMontaging Package

The AutoAOMontaging package is on your Python path. To import it into a Python script or 
session, execute:

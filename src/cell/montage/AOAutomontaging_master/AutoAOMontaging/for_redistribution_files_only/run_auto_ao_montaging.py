...
if __name__ == "__main__":
    run_auto_ao_montaging(
        'P:/AOSLO/_automation/_PROCESSED/Photoreceptors/Healthy/_Results/run/Subject104/Session492',
        'loc.csv',
        'P:/AOSLO/_automation/_PROCESSED/Photoreceptors/Healthy/_Results/run/Subject104/Session492/montaged'
    )

// Pipeline data as a JavaScript module
window.pipelineData = {
  "nodes": [
    {
    ...
    },
    {
      ...
      "label": "results.csv",
      "category": "output",
      "description": "Combined density and thickness measurements for all eccentricities.",
      "details": "Excel-compatible CSV containing cone densities and layer thicknesses for correlation analysis. Primary output for statistical analysis.",
      "doc_link": "docs/outputs.md#results-csv",
      "critical": true
    },
    {
      "id": "spearmans_correlation",
      "label": "spearmans_*.txt", 
      "category": "output",
      "description": "Statistical correlation coefficients and p-values for density-thickness relationships.",
      "details": "JSON files containing Spearman correlation results for each retinal meridian and layer combination.",
      "doc_link": "docs/outputs.md#spearman-correlations",
      "critical": true
    },
    {
      "id": "density_plots",
      "label": "Density Plots",
      "category": "output", 
      "description": "Visualization plots of cone density measurements and model fits.",
      "details": "PNG files showing raw, smoothed, and fitted density curves with bilateral model parameters.",
      "doc_link": "docs/outputs.md#density-plots",
      "critical": false
    },
    {
      "id": "layer_plots",
      "label": "Layer Thickness Plots",
      "category": "output",
      "description": "3D visualizations and correlation plots for retinal layer analysis.",
      "details": "Triangle region plots and density vs thickness correlation visualizations for each layer.",
      "doc_link": "docs/outputs.md#layer-plots", 
      "critical": false
    }
  ],
  "edges": [
    ...
    {
      "source": "density_layer_analysis", 
      "target": "spearmans_correlation",
      "label": "calculates",
      "type": "produces"
    },
    {
      "source": "yellott_calculator",
      "target": "density_plots",
      "label": "visualizes",
      "type": "produces"
    },
    {
